...
## サイトイメージ
- ホーム画面のイメージです。
![アプリ画面](/docs/home_20251110.png)
- AHPのプロジェクト作成画面のイメージです。
![一対比較画面](/docs/edit_20251115.png)
- AHPの一対比較画面のイメージです。
![一対比較画面](/docs/pairwise_20251114.png)
...
- API: Google Gemini API(model: gemini-2.5-flash)、Google OAuth、Supabase Auth、Rakuten Developers
