            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="space-y-6">
                <h2 className="font-semibold flex items-center justify-start">
                  AHPにおけるCIとは？
                  <Help text={helpTexts.consistency.short} title="CIとは？" more={helpTexts.consistency.long} />
                </h2>
              </div>
            </div>
                ...
                {matrices[numMatrix].ci ? matrices[numMatrix].ci < 0.1 ?  (
                  <AnimatePresence>
                     <motion.div
                       ...
                       <Check className="mr-2 p-1 bg-green-500 rounded-full font-bold text-white shadow-sm" size={20} />
                  ...
                  <AnimatePresence>
                    <motion.div
                      ...
                      <AlertTriangle className="p-1 font-bold text-yellow-600" size={25} />
          ...
          <div className="max-w-4xl mx-auto flex justify-end items-center gap-4">
            ...
            <div className="max-w-4xl mx-auto relative my-6">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-background px-2 text-muted-foreground">ご不明点があれば</span>
              </div>
            </div>
            <ChatBox />
        </>
